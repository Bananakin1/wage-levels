...
<div class="app">
  <header class="header">
    <h1>Wage Explorer</h1>
    <p>
      Combines <a href="https://www.onetcenter.org" target="_blank" rel="noopener">O*NET</a> occupation data with <a href="https://flag.dol.gov" target="_blank" rel="noopener">OFLC</a> prevailing wages so you can explore wage levels by occupation at the county level, all in one place. Wages are split into four levels based on pay distribution percentiles: Level I (~17th), II (~34th), III (~50th), IV (~67th). Use "Color by" to pick which level colors the map. Some occupations are flagged "High Wage" by DOL, meaning only an average is available. Filter by Job Zone (1 = little prep, 5 = extensive) or Education to narrow your search. Data covers Jul 2025 through Jun 2026 (May 2024 BLS OEWS survey).
    </p>
    <p class="attribution">
